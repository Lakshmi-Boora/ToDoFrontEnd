...
function App() {
  ...
  const fetchTasks = async (token) => {
    const response = await fetch("https://todobackend1-39yq.onrender.com/task", {
  ...
  const deleteTask = async (id) => {
    const response = await fetch(`https://todobackend1-39yq.onrender.com/task/${id}`, {
      method: "DELETE",
      headers: {
        Authorization: `Bearer ${token}`,
      },
  ...
  const updateTaskStatus = async (id, currentStatus) => {
    ...
    const response = await fetch(
      `https://todobackend1-39yq.onrender.com/tasks/${id}/status`,
      {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
  ...
  const updateTaskPriority = async (id, newPriority) => {
    const response = await fetch(
      `https://todobackend1-39yq.onrender.com/tasks/${id}/priority`,
      {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
